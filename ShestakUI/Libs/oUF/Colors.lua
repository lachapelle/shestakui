...
colors.power = {}
colors.power[0] = {0.00, 0.00, 1.00} -- MANA
colors.power[1] = {1.00, 0.00, 0.00} -- RAGE
colors.power[2] = {1.00, 0.50, 0.25} -- FOCUS
colors.power[3] = {1.00, 1.00, 0.00} -- ENERGY
colors.power[4] = {0.00, 1.00, 1.00} -- HAPPINESS
colors.power[5] = {0.50, 0.50, 0.50} -- RUNES
colors.power[6] = {0.00, 0.82, 1.00} -- RUNIC_POWER
