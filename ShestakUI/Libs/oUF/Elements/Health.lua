...
.frequentUpdates   - Indicates whether to use OnUpdate script (UNIT_HEALTH_FREQUENT replacement) instead of UNIT_HEALTH to update the bar (boolean)
...
local function Update(self, event, unit)
	...
	* unit - the unit for which the update has been triggered (string)
	...
	local cur, max = LMH:GetUnitCurrentHP(unit), LMH:GetUnitMaxHP(unit)
