...
C["position"] = {
	...
	["bgscore"] = {"TOP", UIParent, "TOP", -35, -25},								-- Attempts frame
	["bgscore_toppanel"] = {"TOP", UIParent, "TOP", -35, -C.toppanel.height - 5},	-- Attempts frame w/ Top Panel
	...
	filger = {
		...
		["cooldown"] = {"BOTTOMRIGHT", "oUF_Player", "TOPRIGHT", 63, C.unitframe.plugins_swing and 41 or 29},	-- "COOLDOWN"
