...
T.BuffWhiteList = {
	...
	[SpellName(23099)] = true,	-- Dash (Boar / Cat / Hyena / Raptor / Ravager / Tallstrider / Wolf)
	[SpellName(19263)] = true,	-- Deterrence
	[SpellName(23145)] = true,	-- Dive (Bat / Bird of Prey / Carrion Bird / Dragonhawk / Nether Ray / Wind Serpent)
