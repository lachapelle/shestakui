...
GameTooltip:HookScript("OnTooltipSetUnit", function(self, ...)
	...
	if unit and CanInspect(unit) then
		...
		if unit and CanInspect(unit) and not isInspectOpen then
			...
			if unit == "player" then
				GameTooltip:AddLine(format("|cfffed100"..L_COMPATIBILITY_STAT_AVERAGE_ITEM_LEVEL..":|r "..ail), r, gb, gb)
			else
				GameTooltip:AddLine(format("|cfffed100"..L_COMPATIBILITY_STAT_AVERAGE_ITEM_LEVEL..":|r "..ail).." ("..((d > 0) and "|cff00ff00+" or "|cffff0000")..d.."|r)", r, gb, gb)
			end
			GameTooltip:Show()
		end
	end
