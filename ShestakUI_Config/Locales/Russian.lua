...
L_GUI_MISC_ALREADY_KNOWN = "Помечать цветом известные рецепты" -- Need review
...
L_GUI_COMBATTEXT_THRESHOLD = "Минимально отображаемое значение урона"
L_GUI_COMBATTEXT_HEAL_THRESHOLD = "Минимально отображаемое значение лечения"
...
L_GUI_CHAT_TIMESTAMP_COLOR = "Цвет времени чата"
