...
L_GUI_MISC_ALREADY_KNOWN = "彩色顯示已學會的食譜" -- Need review
...
L_GUI_COMBATTEXT_THRESHOLD = "傷害輸出最小閥值"
L_GUI_COMBATTEXT_HEAL_THRESHOLD = "承受/輸出治療最小閾值"
...
L_GUI_CHAT_TIMESTAMP_COLOR = "時間標簽顏色"
