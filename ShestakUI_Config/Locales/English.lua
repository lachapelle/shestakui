...
L_GUI_GENERAL_NORMALFONT = "Change globally used pixel font to normal font"
...
L_GUI_MISC_ALREADY_KNOWN = "Color recipes that are already known"
...
L_GUI_COMBATTEXT_THRESHOLD = "Minimum damage to show in damage frame"
L_GUI_COMBATTEXT_HEAL_THRESHOLD = "Minimum healing to show in incoming/outgoing healing messages"
...
L_GUI_TOOLTIP_HEALTH = "Numerical health value"
...
L_GUI_CHAT_SPAM = "Remove some system spam ('Player1' won duel 'Player2')"
L_GUI_CHAT_GOLD = "Remove some player spam (gold/portals/etc)"
...
L_GUI_CHAT_TIMESTAMP = "Enable chat timestamps"
L_GUI_CHAT_TIMESTAMP_24 = "24 hour timestamp format"
L_GUI_CHAT_TIMESTAMP_SECONDS = "Display seconds in timestamp"
L_GUI_CHAT_TIMESTAMP_COLOR = "Timestamp coloring"
...
L_GUI_NAMEPLATE_HEALTH = "Numerical health value"
...
L_GUI_ACTIONBAR_SPLIT_BARS = "Split the fifth bar into two bars of 6 buttons each"
...
L_GUI_UF_PLUGINS_COMBO_BAR_OLD = "Show combo point on the target (shows on player when disabled)"
