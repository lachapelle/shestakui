...
L_GUI_MISC_ALREADY_KNOWN = "已拥有食谱物着色" -- Need review
...
L_GUI_COMBATTEXT_THRESHOLD = "伤害输出最小阈值"
L_GUI_COMBATTEXT_HEAL_THRESHOLD = "承受/输出治疗最小阈值"
...
L_GUI_CHAT_TIMESTAMP_COLOR = "时间标签颜色"
...
-- Map options
L_GUI_MAP_BG_STYLIZATION = "开启战场地图增强"
