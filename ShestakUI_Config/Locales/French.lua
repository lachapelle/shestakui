...
L_GUI_MISC_ALREADY_KNOWN = "Colorisation des recettes que vous connaissez déjà" -- Need review
...
L_GUI_COMBATTEXT_THRESHOLD = "Dégâts minimum pour afficher dans la fenêtre de dégâts"
L_GUI_COMBATTEXT_HEAL_THRESHOLD = "Soins minimum pour afficher dans la fenêtre de dégâts"
...
L_GUI_CHAT_TIMESTAMP_COLOR = "Coloration du temps"
